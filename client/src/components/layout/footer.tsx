  ...
  return (
    <footer className="bg-foreground text-primary-foreground py-8">
      <div className="container mx-auto px-4">
        ...
        <div className="border-t border-white/20 mt-6 pt-6 text-center text-sm text-primary-foreground/70">
          <p>© {new Date().getFullYear()} Joy Sparks. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
